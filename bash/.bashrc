...
# PERL_LOCAL="${HOME}/.perl"
# PATH="${PERL_LOCAL}/bin${PATH+:}${PATH}"; export PATH;
# PERL5LIB="${PERL_LOCAL}/lib/perl5${PERL5LIB+:}${PERL5LIB}"; export PERL5LIB;
# PERL_LOCAL_LIB_ROOT="${PERL_LOCAL}${PERL_LOCAL_LIB_ROOT+:}${PERL_LOCAL_LIB_ROOT}"; export PERL_LOCAL_LIB_ROOT;
# PERL_MB_OPT="--install_base \"${PERL_LOCAL}\""; export PERL_MB_OPT;
# PERL_MM_OPT="INSTALL_BASE=${PERL_LOCAL}"; export PERL_MM_OPT;
